sap.ui.define([
    ...
    var comp = UIComponent.extend("airbus.mes.poc.p13n.Component", {
        ...
        init: function () {
            ...
            this.setModel(models.createJsonMyTableModel(), "myTable");
            this.setModel(models.createJsonAllTableModel(), "Tables");
            this.setModel(models.createJsonColumnModel(), "myColumn");
            this.setModel(models.createJsonRowModel(), "myRow");
        }
    });
