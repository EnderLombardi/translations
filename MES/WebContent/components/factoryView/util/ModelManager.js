...
airbus.mes.factoryView.util.ModelManager = {
    ...
    init : function(core) {
        ...
        this.urlModel = new sap.ui.model.resource.ResourceModel({
            bundleName : "airbus.mes.factoryView.config.url_config",
            bundleLocale : dest
        });
    ...
    pulse : function(lineNumber, stationNumber) {
        ...
        jQuery.ajax({
            ...
            success : function(data, textStatus, jqXHR) {
                ...
                sap.m.MessageToast.show("Pulse successful");
                airbus.mes.factoryView.util.ModelManager.refreshFactoryModel();
                sap.ui.core.BusyIndicator.hide();
            },
            error : airbus.mes.factoryView.util.ModelManager.ajaxError
    ...
    pulseLine : function(lineNumber) {
        ...
        jQuery.ajax({
            ...
            success : function(data, textStatus, jqXHR) {
                ...
                sap.m.MessageToast.show("Line Pulse successful");
                airbus.mes.factoryView.util.ModelManager.refreshFactoryModel();
                sap.ui.core.BusyIndicator.hide();
            },
            error : airbus.mes.factoryView.util.ModelManager.ajaxError
    ...
    refreshOperation : function(oEvt) {
        ...
        jQuery.ajax({
            ...
            success : function(data, textStatus, jqXHR) {
                ...
                sap.m.MessageToast.show("Refresh successful");
    ...
    onProductionModelLoaded : function() {
        ...
        for (var i = 1; i <= 8; i++) {
            if (ModelData[k] && ModelData[k].Station == 5) {
                ...
                ModelData[k].Image = airbus.mes.shell.ModelManager.getResourceUrl('station.img.root')
                                     + ModelData[k].Station + ".png";
                ...
                var oJson = {
                    ...
                    "HAND" : "",
                    "RTO" : 0,
                    "Image" : airbus.mes.shell.ModelManager.getResourceUrl('station.img.root')
                            + airbus.mes.factoryView.util.ModelManager.StationList[i] + ".png",
