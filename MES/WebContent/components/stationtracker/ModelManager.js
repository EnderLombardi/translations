...
airbus.mes.stationtracker.ModelManager = {
	...
	init : function(core) {
		...
		core.setModel(new sap.ui.model.json.JSONModel(), "ressourcePoolModel"); // Resource//
		// poolModel
		core.setModel(new sap.ui.model.json.JSONModel(), "groupModel"); // Unplanned//
		// Filter//
		// Model
		core.setModel(new sap.ui.model.json.JSONModel(), "KPIextraWork"); // KPI
		// Extra
		// Work
		core.setModel(new sap.ui.model.json.JSONModel(), "KPItaktAdherence"); // KPI
		// Takt
		// Adherence
		...
		core.getModel("ressourcePoolModel").attachRequestCompleted(
				airbus.mes.stationtracker.ModelManager.onRessourcePoolLoad);
		...
		if (airbus.mes.stationtracker.ShiftManager.shiftDisplay) {
			...
			airbus.mes.stationtracker.oView
					...
					.setSelectedKey(
							airbus.mes.stationtracker.ShiftManager.ShiftSelected.shiftID);
			scheduler
					.updateView(airbus.mes.stationtracker.ShiftManager.ShiftSelected.StartDate);
