    	   ...
    	   $.ajax({
   			...
   			success : function(data, textStatus, jqXHR) {
   				...
   				if(airbus.mes.shell.util.Formatter.getMiiMessageType(data) == "E"){
   					...
   					airbus.mes.stationtracker.oView.getController().openCheckQAPopup("confirm", checkQAModel);
       ...
       **************************************************************************/
       openOperationDetailPopup : function(aModel) {
              ...
              if (aModel[0].status == "0")
                     ...
                     sStatus = "NOT_STARTED";
              else if (aModel[0].status === "D1" || aModel[0].status === "D2" || aModel[0].status === "D3" || aModel[0].status === "D4")
