...
*/
	...
	//Time in Header
	var oTimeFormat = sap.ui.core.format.DateFormat.getTimeInstance({pattern: "HH:mm"}); //Returns a DateFormat instance for time
...
//      settingsView--selectLine
  ...
  /**
   * Called when selecting Program, Line and Station from select in Add/Modify Station Popup
   */
  ...
  onSelectionChange : function(oEvt){
      ...
      if (oEvt.getSource()) {
          ...
          var id = oEvt.getSource().getId().split("--")[0];
