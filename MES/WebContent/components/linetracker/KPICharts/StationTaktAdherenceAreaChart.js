...
//				bindable: "bindable"
	...
	renderer: function (oRm, oControl) {
		...
		oRm.write(" class='station_takt_adherence_area_chart' viewBox='0 0 180 60' perserveAspectRatio='xMinYMid'");
		oRm.write(" />");
	},
	...
	onAfterRendering: function onAfterRendering(oEvt){
		...
		var chart = $("#idLinetracker1--station_takt_adherence_area_chart"),
			aspect = 0.3,
		...
		var svg = d3.select("svg.station_takt_adherence_area_chart")
