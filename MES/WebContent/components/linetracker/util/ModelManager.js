...
airbus.mes.linetracker.util.ModelManager = {
    ...
    // Models for New linetracker    	
		...
		sap.ui.getCore().getModel("dataModel").loadData("../components/linetracker/local/data.json",null,false);
		
		var oModel = new sap.ui.model.resource.ResourceModel({bundleName:"airbus.mes.linetracker.i18n.i18n"});
		...
		sap.ui
				...
				.loadData(
						"../components/linetracker/KPICharts/data/KPItaktEfficiencyModel.json",
						null, false);
		//Takt Adherence
		sap.ui.getCore().setModel(
				new sap.ui.model.json.JSONModel(),
		...
		sap.ui
				...
				.loadData(
						"../components/linetracker/KPICharts/data/KPItaktAdherenceModel.json",
						null, false);
		//Shift Staffing
		sap.ui.getCore().setModel(
				new sap.ui.model.json.JSONModel(),
		...
		sap.ui
				...
				.loadData(
						"../components/linetracker/KPICharts/data/KPIshiftStaffingModel.json",
						null, false);
		// Extrawork
		sap.ui.getCore().setModel(
				new sap.ui.model.json.JSONModel(),
		...
		sap.ui
				...
				.loadData(
						"../components/KPICharts/data/KPIextraWorkModel.json",
						null, false);
		//KPI Model
		sap.ui.getCore().setModel(
				new sap.ui.model.json.JSONModel(),
		...
		sap.ui
				...
				.getModel("KPI")
				.loadData(
						"../components//linetracker/KPICharts/data/KPIModel.json",
						null, false);
        ...
        sap.ui
                      ...
                      .loadData("../components/linetracker/KPICharts/data/KPIdisruptionModel.json",
                                    null, false);
      ...
      //KPI Resolution Efficiency Model
		...
		sap.ui
				...
				.loadData(
						"../components/linetracker/KPICharts/data/KPIresolutionEfficiencyModel.json",
						null, false);
