sap.ui.controller("airbus.mes.linetracker.FactoryView", {
	...
	onLinePress : function(oEvt) {
		...
		airbus.mes.linetracker.util.ModelManager.line_number = oEvt.getSource().getText().substring(5, 6);
	...
	/*not needed anymore*/
	ClearStation5 : function (lineNumber) {this.processing(lineNumber, "05", "", "", '', '');},				
...
//				if (!this.openLoad) {
					var openLoad = sap.ui.jsfragment("Station5Load", this);
//				}
				openLoad.open();
				}
			  break;
...
//								sap.ui.getCore().byId('L' + this.line_number + 'ST05').getModel().setData(tModel.oData);
								...
								airbus.mes.linetracker.util.ModelManager.loadUnloadStation5(MSN,HAND/*,LINE_NUMBER*/);
