				...
				"airbus.mes.polypoly.polypoly",
				{
					...
					onInit : function() {
						...
						PolypolyManager.getPolypolyModel(
								...
								ModelManager.station_number, ModelManager.site);
						sap.ui.getCore().getModel("mii")
								.attachRequestCompleted(
										PolypolyManager.onModelLoaded);
					...
					onRPSuggest : function(oEvt) {
						...
						sap.ui.getCore().byId("polypolyView").getController().onRPSearch(oEvt);
					},
					...
					setVisible: function(){
						return  PolypolyManager.globalContext.tabSelected == "polypoly" ? true:false;
					}
