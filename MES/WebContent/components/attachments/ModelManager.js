"use strict";
jQuery.sap.declare("airbus.mes.attachments.ModelManager")
airbus.mes.attachments.ModelManager = {
		urlModel : undefined,
		...
		init : function(core) {
			...
			this.urlModel = new sap.ui.model.resource.ResourceModel({
				bundleUrl : "../components/attachments/config/url_config.properties",
				bundleLocale : dest
			});
			
			if (  dest === "sopra" ) {

				var oModel = airbus.mes.attachments.ModelManager.urlModel._oResourceBundle.aPropertyFiles[0].mProperties;
