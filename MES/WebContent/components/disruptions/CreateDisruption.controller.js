...
.controller(
	"airbus.mes.disruptions.CreateDisruption",
	{
		...
		onUploadComplete : function(loValue) {
			...
			if(sType === 'txt'){var sIcon = "sap-icon://document-text"}
			if(sType === 'doc' || sType === 'docs'){var sIcon = "sap-icon://doc-attachment"}
			if(sType === 'pdf'){var sIcon = "sap-icon://pdf-attachment"}
			if(sType === 'xlsx'){var sIcon = "sap-icon://excel-attachment"}
			if(sType === 'pptx' || sType === 'ppt'){var sIcon = "sap-icon://ppt-attachment"}
...
//			var oTable = sap.ui.getCore().byId("idAttachmentTable");
		...
		showAttachedDocsList : function(oEvent) {
			...
			AttachmentHeader.setText("Attachments ("+iLength+")");
		...
		onPressDeleteButton : function(oEvent) {
			...
			oLink.setText(iCount + " Attachments");
			...
			oAttachmentHeader.setText("Attachments ("+iLength+")");
		}
		/*
		 * onExit: function() { }
		 */
