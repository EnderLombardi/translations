...
*/                                         //*********************************************************
                                  ...
                                  */
                                  ...
                                  onEscalateDisruption : function(oEvent) {
                                      ...
                                      var sMessageSuccess = this.getview().getModel("i18nModel").getProperty("successSolved");
                                      // Call Escalate Service
                                      airbus.mes.disruptions.ModelManager.escalateDisruption(msgRef, comment, sMessageSuccess);
