				...
				"airbus.mes.shell.globalNavigation",
				{
					...
					renderViews : function() {
						...
						case "stationTrackerView":
							...
							this.autoRefresh = window.setInterval(
									this.renderStationTracker, 300000);
					...
					goToMyProfile : function() {
						if (!this._myProfileDailog) {
							this._myProfileDailog = sap.ui.xmlfragment(
					...
					onScanMyProfile : function() {
						...
						ws.onmessage = function(evt) {
							...
							sap.ui.getCore().getElementById("uIdMyProfile")
									.setValue(uID);
							sap.ui.getCore().getElementById("badgeIdMyProfile")
									.setValue(badgeID);
							sap.ui.getCore().getElementById("msgstrpMyProfile")
									.setVisible(false);
						...
						ws.onerror = function(evnt) {
							var connectionError = sap.ui.getCore().getModel(
					...
					onSaveMyProfile : function(oEvent) {
						...
						if (badgeID == "" || uID == "" || user == ""
							...
							if (badgeID === "") {
								sap.ui.getCore().getElementById(
										"badgeIdMyProfile").setValueState(
										sap.ui.core.ValueState.Error);
							} else {
								sap.ui.getCore().getElementById(
										"badgeIdMyProfile").setValueState(
