...
var translateTool = require('./src/gulp-translation-tool');
var tableViewerTool = require('./src/gulp-table-viewer-tool');
...
//--------------------------------------------------------------------------------------------------------------------------//
//																															//
//															serve-translate-tool															//
//																															//
//--------------------------------------------------------------------------------------------------------------------------//

gulp.task('serve-translate-tool', function () {
	return gulp.src(['./**'], { cwd: dest }) 
		.pipe(translateTool());
});
//--------------------------------------------------------------------------------------------------------------------------//
//																															//
//															serve-tableviewer-tool															//
//																															//
//--------------------------------------------------------------------------------------------------------------------------//

gulp.task('serve-tableviewer-tool', function () {
	return gulp.src(['./**'], { cwd: dest }) 
		.pipe(tableViewerTool());
});